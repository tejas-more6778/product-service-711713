...
public class CategoryModel {
	...
	public CategoryModel(@Min(value = 1, message = "Invalid Supplier Id") long categoryId,
			@NotBlank(message = "Category Name Should Not be Blank") @Pattern(regexp = "^[a-zA-Z ]+$", message = "Supplier name should only contain alphabets and spaces") String categoryName,
			@NotBlank(message = "Description Name Should Not be Blank") String description,
			@Min(value = 1, message = "Invalid Supplier Id") int discount,
			@Min(value = 1, message = "Invalid Supplier Id") int gst, int deliveryChargesAmount) {
		super();
