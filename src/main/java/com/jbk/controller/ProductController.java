...
public class ProductController {
	...
	public ResponseEntity<Product_Supplier_Category> getProductByIdSC(@PathVariable long productId) {
		Product_Supplier_Category psc = service.getProducWthSCtById(productId);
